...
<form method="get" class="addRemoveForm" action="{{ route('rate.update',['tariffId'=>$info->tariff->id,'id'=>$info->id]) }}" accept-charset="UTF-8" style="padding: 100px;" data-role="validator">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <div class="row pt-2 pb-2">
        <div class="cell-md-6 pt-2">
            <p>From Rate</p>
            <input class="large" name="fromRate" value="{{$info->from}}" type="number"  data-validate="required"
                   id="fromRate" readonly>
        </div>
